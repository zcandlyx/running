...
var _mine = __webpack_require__(/*! @/api/mine.js */ 12);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
var self;var _default =
{
  ...
  onShow: function onShow() {
    ...
    self = this;
    var sessionKey = this.$store.getters.getSessionKey;
    if (!sessionKey) {
      this.init();
      return;
    }
